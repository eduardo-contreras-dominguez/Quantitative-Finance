...
op=pd.read_csv('data/inputDataOHLCDaily_20120424_op.csv')
hi=pd.read_csv('data/inputDataOHLCDaily_20120424_hi.csv')
lo=pd.read_csv('data/inputDataOHLCDaily_20120424_lo.csv')
cl=pd.read_csv('data/inputDataOHLCDaily_20120424_cl.csv')

stocks=pd.read_csv('data/inputDataOHLCDaily_20120424_stocks.csv')
